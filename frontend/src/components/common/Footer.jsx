          ...
          <div>
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4">
                ...
                <a href="mailto:contact@dgtlmart.com" className="text-slate-300 hover:text-blue-400 transition-colors">
              ...
              <li className="flex items-start gap-4">
                ...
                <a href="tel:+919810559439" className="text-slate-300 hover:text-blue-400 transition-colors">
                  +91 9810559439
                </a>
              </li>
            </ul>
