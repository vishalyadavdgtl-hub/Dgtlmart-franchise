...
export const referralAPI = {
  ...
  sendLoginOTP: (data) => api.post('/referral/send-login-otp', data),
  loginWithOTP: (data) => api.post('/referral/login-with-otp', data),
...
export const franchiseAPI = {
  ...
  login: (credentials) => api.post('/franchise/client/login', credentials),
  sendLoginOTP: (data) => api.post('/franchise/client/send-login-otp', data),
  loginWithOTP: (data) => api.post('/franchise/client/login-with-otp', data),
